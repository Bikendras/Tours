          ...
          return (
            <div className='card_m'>
              <div className='card_detail'>
                <div>
                  <label className='tour-price'>{x.price}</label>
                  <img src={x.image} className='image' alt="img" />
                </div>
                <div className='card_d'>
                  <h1>{x.name}</h1>
                  <p>  {readMore ? `${x.info}` : `${x.info.substring(0, 200)}...`}
                    <button className='button_1' onClick={() => setReadMore(!readMore)}>{readMore ? "show less" : "read more"}</  button>
                  </p>
                  <button className='button_2'>not interested</button>
                </div>
              </div>
            </div>
          )
